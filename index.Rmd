...
display_pal <- function(pkg, palette, n, pal_function) {
  ...
  print(glue('paletteer::{f}("{pkg}::{palette}")'))

  # The color palettes
  cat("\n")
  print(glue('paletteer::{pal_function}("{pkg}::{palette}")'))
}
```
...
# htmltools::tagList(htmltools::tags$h1("fsdf")
df %>%
